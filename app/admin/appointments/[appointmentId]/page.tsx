...
const MOCK_APPOINTMENT: AppointmentDetail = {
	...
	price: "৳3,500",
	notes:
		"Braces adjustment — 3rd session. Patient requests earlier slot if possible.",
	symptoms:
		"Mild discomfort around upper molars. Slight misalignment noted on last visit.",
	diagnosis: "Malocclusion — Class II, Division 1. Braces therapy in progress.",
	prescription:
		"Orthodontic wax as needed for bracket irritation. Warm saline rinse twice daily.",
};
...
function MedicalField({ label, value }: { label: string; value?: string }) {
	return (
            ...
            */}
						...
						<CardContent className="pt-0">
							<InfoRow
								icon={User}
								label="Patient"
								value={`${appt.patient} · ${appt.patientId}`}
							/>
					...
					<Card className="border-destructive/30">
						...
						<CardContent className="pt-0">
							<p className="mb-4 text-xs text-muted-foreground leading-relaxed">
								Cancelling this appointment is permanent. The patient will need
								to rebook.
							</p>
