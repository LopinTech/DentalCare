  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-white">
        ...
        <svg
          aria-hidden="true"
          className="pointer-events-none absolute right-[-6rem] top-[-4rem] w-[560px] opacity-[0.045] select-none hidden lg:block"
          viewBox="0 0 400 420"
          fill="none"
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              ...
              <div key={step} className="relative">
                ...
                <div className="hidden md:block absolute top-6 left-[calc(100%_-_1rem)] w-[calc(100%_-_2.5rem)] h-px bg-[#d1fae5] z-0" />
