    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">Active and past treatment plans.</p>
        </div>
        <Button size="sm"><Stethoscope className="size-4" />New Plan</Button>
      </div>
      <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border py-16 text-center">
        ...
        <p className="text-xs text-muted-foreground mt-1 mb-4">Create a plan to track procedures and progress.</p>
        <Button size="sm" variant="outline"><Stethoscope className="size-4" />Create First Plan</Button>
      </div>
    </div>
  );
}
