...
export function AdminBottomNav() {
  ...
  const isMoreActive =
    !BOTTOM_TABS.some(
      (t) => pathname === t.href || (t.href !== "/admin" && pathname.startsWith(t.href))
    ) && pathname !== "/admin";
        ...
        {BOTTOM_TABS.map(({ label, href, icon: Icon }) => {
          ...
          return (
            <Link
              ...
              href={href}
              className={cn(
                "flex flex-1 flex-col items-center gap-1 pt-2.5 pb-2 text-[10px] font-semibold transition-colors",
